...
from model.depth_model_unetresnet34 import DepthEstimationUNetResNet34
...
def convert_checkpoint_to_onnx(checkpoint_path, onnx_output_path, input_size=(1, 3, 224, 224)):
    ...
    #     pretrained=True
    # )
    model = DepthEstimationUNetResNet34.load_from_checkpoint(
        checkpoint_path,
        lr=1e-4,
        pretrained=True
    )
...
# Example usage
checkpoint_path = '../test_model/depth-estimation-epoch=28.ckpt'
onnx_output_path = '../test_model/depth-estimation_model_unetresnet34.onnx'
